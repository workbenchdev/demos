...
const revealer = workbench.builder.get_object("revealer") as Gtk.Revealer;
const button = workbench.builder.get_object("button") as Gtk.Button;
const avatar = workbench.builder.get_object("avatar") as Adw.Avatar;
const entry = workbench.builder.get_object("entry") as Adw.EntryRow;
const username = workbench.builder.get_object("username") as Gtk.Label;
const display = workbench.builder.get_object("name") as Gtk.Label;
