...
pic_with_frame = workbench.builder.get_object("with_frame")
pic_without_frame = workbench.builder.get_object("without_frame")

textview_with_frame = workbench.builder.get_object("textview_with_frame")
textview_without_frame = workbench.builder.get_object(
    "textview_without_frame",
)

file = Gio.File.new_for_uri(workbench.resolve("./image.png"))
...
textview_with_frame.set_buffer(buffer)
textview_without_frame.set_buffer(buffer)

pic_with_frame.set_file(file)
pic_without_frame.set_file(file)
