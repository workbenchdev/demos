...
public void main () {
    ...
    var pic_without_frame = (Gtk.Picture) workbench.builder.get_object ("without_frame");
    var textview_with_frame = (Gtk.TextView) workbench.builder.get_object ("textview_with_frame");
    var textview_without_frame = (Gtk.TextView) workbench.builder.get_object ("textview_without_frame");

    File file = File.new_for_uri (workbench.resolve ("./image.png"));
