...
const subpage_row = workbench.builder.get_object<Adw.ActionRow>("subpage_row");
const subpage_button = workbench.builder.get_object<Gtk.Button>("subpage_button");
const toast_button = workbench.builder.get_object<Gtk.Button>("toast_button");
